...
'''
Example module to receive data on the desktop
Work on Python 3.7.4 of Manjaro Linux
...
img_routine = routine('rpi3b/img', None, False, img_process)
photon_routine = routine('rpi3b/photon', 'None', False, photon_process)
receive_routine = [img_routine, photon_routine]

class myMQTTReceiver():
    def __init__(self, server_ip=None, server_port=None, client_id='desktop'):
        '''
        Args:
    ...
    def on_message(self, client, userdata, msg):
        ...
        for r in receive_routine:
            if msg.topic == r.sub_topic:
                ...
                if not r.process:
                    # if no processing here, directly save the data
                    pass
                else:
